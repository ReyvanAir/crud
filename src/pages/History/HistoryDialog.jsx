        ...
        <DialogContentText>
          <table className='mt-4 w-full select-text'>
            ...
            <tbody className='border border-tertiary' style={{backgroundColor: '#FDF3D3'}}>
              {data.map((row, index) => (
                <tr key={index}>
                  <td className='px-2 border-y border-tertiary whitespace-nowrap'>{row.username}</td>
                  <td className='px-2 border-y border-tertiary whitespace-nowrap'>{row.kill} / {row.death}</td>
                  <td className='px-2 border-y border-tertiary whitespace-nowrap'>{row.score}</td>
                </tr>
              ))}
            </tbody>
          </table>
