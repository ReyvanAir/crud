            ...
            <div className="flex-[3] overflow-y-auto flex flex-col gap-4">
              <CardWrapper title="OVERVIEW">
                <Card
                  ...
                  value={
                    data.AI.simulationPlayed +
                    data.teamPVE.simulationPlayed +
                    data.teamPVP.simulationPlayed
                  }
                  details={[
                ...
                <Card
                  title="Kill/Death"
                  value={(
                    (data.AI.kill + data.teamPVE.kill + data.teamPVP.kill) /
                    (data.AI.death + data.teamPVE.death + data.teamPVP.death)
                  ).toFixed(2)}
                  details={[
                    [
                      "Kills",
                ...
                <Card
                  title="Win/Lose"
                  value={(
                    (data.AI.win + data.teamPVE.win + data.teamPVP.win) /
                    (data.AI.lose + data.teamPVE.lose + data.teamPVP.lose)
                  ).toFixed(2)}
                  details={[
              ...
              {selectedMode === "AI" ? (
                ...
                selectedMode === "TeamPVP" && (
                  <CardWrapper title="PVP OVERVIEW">
                    ...
                    <Card
                      title="Kill/Death"
                      value={(data.teamPVP.kill / data.teamPVP.death).toFixed(
                        2
                      )}
                      details={[
